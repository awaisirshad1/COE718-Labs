...
/*	A basic snake game, with or without borders, taken from https://github.com/mfoee/MCB1700 
*/
...
// 	char fd[20];
	...
	while(!done){
		...
		GLCD_DisplayString(29,0,0,"   press joystick to select the mode, left to exit   ");
