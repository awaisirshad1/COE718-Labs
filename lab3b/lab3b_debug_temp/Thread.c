...
osThreadDef (ThreadB, osPriorityLow, 1, 0);                   // thread object

osThreadId tid_E_Thread; // thread id
osThreadDef (ThreadE, osPriorityLow, 1, 0);                   // thread object
...
osThreadDef (ThreadC, osPriorityHigh, 1, 0);                   // thread object
